...
DRAMREGS_2CS = ./tools/doimage_dove/dramregs/dramregs_db_x0_dec_6_2cs.txt
endif
...
#=======================
	@if [ "$(findstring 6781z0,$(RULE))" ] ; then\
		...
		echo "  * Configured for MV88F6781X0"; \
...
#=======================
	...
	elif [ "$(findstring rd88ap510_a0_avng_config,$(RULE))" ] ; then\
